...
const routes = [
  ...
  { path: '/inputs', exact: true, name: 'Inputs', component: TheUserInputs },
  { path: '/logistics', exact: true, name: 'Logistics', component: LogisticsDashboard },
  {
    path: '/logistics/delayed-shipments',
    exact: true,
    name: 'Delayed Shipments',
    component: LogisticsLandingPage,
  },
]
